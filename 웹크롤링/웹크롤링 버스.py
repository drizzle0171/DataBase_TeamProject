...
close.click()
search_more = browser.find_element_by_css_selector('li.option3.option3-ACTIVE > a')
search_more.click()
#browser.find_element_by_css_selector('#info\.searchHeader\.message > div.BusMessageView > div:nth-child(1) > a').click()
time.sleep(3)
